...
local source_patterns = function(source_dir_name)
	return { source_dir_name.."/**.hpp", source_dir_name.."/**.cpp" }
end
...
local add_sources = function(source_dir_name)
	...
	create_source_vpaths(patterns, source_dir_name)
	files(patterns)
end
...
local add_precompiled_header = function(name)
	local pch_header_path = "src/"..name..".pch.hpp"
	local pch_source_path = "src/"..name..".pch.cpp"
...
local create_main_project = function(name)
	...
	create_source_project(name, "src")
